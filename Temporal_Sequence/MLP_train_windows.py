...
def load_dataset(csv_file):
    ...
    return X, y
# 加载训练集和测试集
X_train, y_train = load_dataset(r'D:\GitHub\Temporal_NPS\Temporal_Sequence\dataset\train.csv')
X_test, y_test = load_dataset(r'D:\GitHub\Temporal_NPS\Temporal_Sequence\dataset\test.csv')
# print(X_train)
# print(X_test)
# print(y_train)
# print(y_test)
...
def train_eval_model(model, train_loader, criterion, optimizer, epochs=100):
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            ...
            if test_auc > max_auc:
                torch.save(model, r'D:\GitHub\Temporal_NPS\Temporal_Sequence\model\windows_reserved\model_max.pth')
                max_auc = test_auc
                bestepoch = epoch+1
            print(f'current auc: {test_auc}')
...
model = torch.load(r'D:\GitHub\Temporal_NPS\Temporal_Sequence\model\windows_reserved\model_max.pth')
