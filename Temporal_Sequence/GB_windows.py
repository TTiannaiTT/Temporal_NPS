...
X_train = train_data.iloc[5000:6000, 3:].values

# y_train = train_data.iloc[:, 2].values
y_train = train_data.iloc[5000:6000, 2].values
...
# 初始化梯度提升分类器
gb_clf = GradientBoostingClassifier(n_estimators=1000, learning_rate=0.1, max_depth=5, random_state=42)
# 训练模型
